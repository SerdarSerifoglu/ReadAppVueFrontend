<template>
  <div>
    <app-combobox :mainData="packComboboxData" @comboboxChange="packComboboxChange($event)" />
    ...
    <button class="btn btn-primary btn-md" @click="wordData._id != undefined ? updateWord() : saveWord()">
      <span>
        <i class="fas fa-plus"></i>
      </span>
      Save
      ...
      <table class="table table-sm">
        ...
        <tbody>
          <tr v-for="word in words" :key="word._id">
            ...
            <td>
              <button class="btn btn-success" @click="editButtonClick(word._id)">
                Edit
              </button>
              <span> | </span>
              <button class="btn btn-danger" @click="deleteButtonClick(word._id)">
                Delete
              </button>
            </td>
          </tr>
