  ...
  <div class="container" style="margin-top: 75px">
    <div class="mainView" @mouseup="selectWord">
      <div class="row">
        ...
        <div class="col-sm-3">
          <button type="button" class="btn btn-primary float-right" @click="addWordButtonClick()">
            Add Word
          </button>
        </div>
      </div>
        ...
        <div class="modal-content">
          <div style="margin: 2rem">
            ...
            <div class="modal-footer">
              <button class="btn btn-success center" @click="insertOrUpdateWord()" :disabled="$v.wordData.$invalid">
